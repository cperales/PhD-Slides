...
% 1
\frame{\frametitle{Inteligencia artificial. Machine Learning}
...
\frame{
En problemas de regresión, clásicamente se utiliza el error cuadrático medio, o \textit{Mean Squared Error}, que es equivalente a calcular la norma $L2$ entre el conjunto de variables targety el conjunto predicho de variables reales, y el conjunto
}
